...
export function useCheckoutData() {
    return useLoaderData() as Awaited<ReturnType<typeof checkoutLoader>>;
}

export function CheckoutPage() {
    const { prices } = useCheckoutData();
    ...
    useEffect(() => {
        if (!checkoutData) navigate("/", { replace: true });
    }, [checkoutData, navigate]);

    if (!checkoutData) return null;

    const price = prices[checkoutData.category];
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        <p className="text-sm text-gray-500 font-bold uppercase tracking-wider">Trilha Selecionada</p>
                ...
                <div className="space-y-4 border-t border-gray-50 pt-6">
                    <div className="flex justify-between">
                        ...
                        <span className={`font-bold ${category === "vip" ? "text-amber-600" : "text-gray-900"}`}>
                ...
                {!isFree ? (
                    ...
                    <div className="bg-emerald-50 text-emerald-700 p-6 rounded-2xl border border-emerald-100 mb-6">
                        <p className="font-medium text-center">
                            Esta sessão já está inclusa no seu passe da trilha. Confirme abaixo para garantir sua vaga.
                        </p>
                    </div>
                )}
